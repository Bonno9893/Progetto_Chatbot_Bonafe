...
def search_images(update: Update, context: CallbackContext):
    ...
    if not found_any:
        update.message.reply_text('Nessuna immagine trovata per la tua ricerca. Riprova utilizzando il simbolo "#" prima della parola chiave o prova a cercare con un altra parola chiave!', reply_markup=help_button())
